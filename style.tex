...
% DMR
%\usecolortheme[RGB={5,114,144}]{structure}
% Sysmic
...
\setbeamertemplate{background canvas}{
  \tikz {
    \node at (0,0) {};
    \node[inner sep=0pt, opacity=0.2] at (0.5\paperwidth,-0.8\paperheight) {\includegraphics[width=128mm]{pics/filigranne-sysmic}};
  }
}
