...
% Logo en filigranne
\setbeamertemplate{backround canvas}{
  \tikz {
    \node at (0,0) {};
    \node[inner sep=0pt, opacity=0.2] at (0.5\paperwidth,-0.5\paperheight) {\includegraphics[height=27.2mm,width=65.1mm]{pics/logo}};
  }
}
...
\renewcommand\c[1]{\lstinline[language=c]{#1}}
