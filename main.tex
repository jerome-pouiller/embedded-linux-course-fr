...
%\institute[Sysmic]{}
\institute[Sysmic]{\hspace*{1cm}\pgfimage[height=1.5cm]{pics/logo-sysmic}}
% Plus complet:
%\institute[Sysmic]{
%   \inst{1} \hspace*{1cm}\includegraphics[height=1.5cm]{pics/logo-sysmic}
%   \and
%   \inst{2} \includegraphics[height=1.5cm]{pics/logo-dmr}
%   %\and
%   %\inst{3} \includegraphics[height=1.5cm]{pics/logo-tamia}
%}
%\date[Décembre 2015]{8-11 Décembre 2015}
\date{}
% Pour le PDF seulement:
\subject{Linux embarqué}
\keywords{Linux, OS, sysmic, embarqué, embedded}
