...
\begin{frame}[fragile=singleslide]{Les modules noyau}{my\_module}
  \lstinputlisting[language=c,firstline=16]{samples/mod1_tmpl/mod1_tmpl.c}
\end{frame}
...
\begin{frame}[fragile=singleslide]{Les modules noyau}{my\_module}
  \lstinputlisting[language=c,lastline=14]{samples/mod1_tmpl/mod1_tmpl.c}
\end{frame}
...
obj-$(MY_COMPILE_OPTION) := my_module.o  
  ...
  \lstinputlisting[language=]{samples/mod1_tmpl/Kconfig}
\end{frame} 
